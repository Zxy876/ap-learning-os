-- AP Learning OS hosted Postgres schema draft.
-- This mirrors online_platform/schema.sql while replacing SQLite-specific
-- defaults with Postgres-compatible types.
